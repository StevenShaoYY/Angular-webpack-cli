export default class utilsService{
	 ...
	 * @return {Boolean}        
	 */
	betweenVersion(version, lower, upper) {
	...
	//浏览器标识码
	//var this._userAgent = window.navigator.userAgent.toLowerCase();
	...
	//判断是否是微信环境
	isWechat() {
		if (this._userAgent.match(/MicroMessenger/i) == "micromessenger") {
			return true;
		}
		return false;
	};
